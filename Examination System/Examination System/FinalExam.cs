...
namespace Examination_System
{
    ...
    {
        public FinalExam(int _TimeOfExam, int _NumberOfQuestions, Question[] _Questions) : base(_TimeOfExam, _NumberOfQuestions, _Questions)
        {
        }
        ...
        public override void ShowExam()
        {
            ...
            for (int i = 0; i < Questions?.Length; i++)
            {
                ...
                {
                    promptMessage = "Please enter the answer ID (0 for True | 1 for False): ";
                }
